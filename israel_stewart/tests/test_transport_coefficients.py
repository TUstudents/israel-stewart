...
class TestKineticTheoryModel:
    ...
    def test_relaxation_time_consistency(self):
        ...
        assert (
            0.5 < ratio < 2.0
        ), f"Relaxation time scaling seems wrong: expected ≈{expected_tau_pi}, got {tau_pi}"
...
class TestQCDInspiredModel:
    ...
    def test_kss_bound(self):
        ...
        assert (
            abs(eta_over_s - self.model.eta_s_min) < 0.01
    ...
    def test_relaxation_time_scales(self):
        ...
        assert (
            0.1 * expected_scale < tau_pi < 10 * expected_scale
...
class TestTransportCoefficientCalculator:
    ...
    def test_second_order_coefficients(self):
        ...
        assert (
            0.1 * expected_scale < coeffs.lambda_pi_pi < 10 * expected_scale
    ...
    def test_causality_constraint(self):
        ...
        for T in T_values:
            if T > 0:
                ...
                assert (
                    coeffs.shear_relaxation_time > 0
