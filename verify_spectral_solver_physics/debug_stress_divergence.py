...
print(f"  Expected: (32, 32, 16, 3)")
print()

print(f"Components at (8, 0, 0):")
...
print(f"Ratio: {div_solver_fft[k_idx, 0, 0] / expected_div_fft if abs(expected_div_fft) > 1e-14 else 'N/A'}")
print()
